...
def analyze_package(profile: profile.Profile, package_path: str, secure_mode: bool = False) -> None:
    """
    ...
    sandbox_container = containers.create_sandbox_container(profile.docker_client, profile.image_name, package_path, secure_mode)
